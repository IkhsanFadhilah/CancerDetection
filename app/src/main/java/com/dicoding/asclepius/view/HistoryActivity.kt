...
import com.dicoding.asclepius.adapter.HistoryAdapt
...
class HistoryActivity : AppCompatActivity(), HistoryAdapt.OnDeleteClickListener {

    private lateinit var predictionRecyclerView: RecyclerView
    private lateinit var predictionAdapter: HistoryAdapt
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        predictionRecyclerView = findViewById(R.id.rvHistory)
        tvNotFound = findViewById(R.id.tvNotFound)
        predictionAdapter = HistoryAdapt(predictionList)
